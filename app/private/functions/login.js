  ...
  function submitLogin() {
    ...
    $.ajax({
      ...
      success: function (response) {
        if (response == "user") {
          $("#login_btn").html(
            '<div><i class="fas fa-spinner fa-spin mr-2 orange-text"></i>Signing In ...</div>'
          );
          ...
          $("#msg").fadeIn(1000, function () {
            $("#msg").html(
              '<div class="alert alert-danger"><i class="fas red-text fa-skull-crossbones"></i> E-mail or Password wrong! </div>'
            );
